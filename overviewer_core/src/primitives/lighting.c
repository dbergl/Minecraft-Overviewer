...
estimate_blocklevel(RenderPrimitiveLighting *self, RenderState *state,
    ...
    /* no longer a guess */
    if (!(block == 44 || block == 53 || block == 67 || block == 108 || block == 109 || block == 180 || block == 182 || block == 203) && authoratative) {
        *authoratative = 1;
    }
    ...
    if (block == 44 || block == 53 || block == 67 || block == 108 || block == 109 || block == 114 ||
        ...
        do {
            ...
            upper_block = get_data(state, BLOCKS, x, y + upper_counter, z);
                 ...
                 upper_block == 164 || upper_block == 180 || upper_block == 182 || upper_block == 203 ||
                 upper_block == 205);
